...
# Katakana Dakuten/Handakuten/Loan sounds
'ガ','ギ','グ','ゲ','ゴ','ザ','ジ','ズ','ゼ','ゾ',
'ダ','ヂ','ヅ','デ','ド','バ','ビ','ブ','ベ','ボ',
'パ','ピ','プ','ペ','ポ','ヴ','ッ','ン', 
'ェ','ォ','ャ','ュ','ョ','ワ','ヰ','ヱ','ヲ', # Loan phonics variants
...
'フ','ル','デ','ム','プ', # (Kana holdovers categorized in logic)
'人','大','小','中','上','下','左','右','心',
'見','聞','行','来','出','入','使','知','思',
'新','古','多','少','高','低','良','悪','長','短',

# ================= 7. NEW EXTENDED KANJI (106) =================
# Core UI & System
'全','部','分','数','値','計','算','変','更','リ','ト', # (System building blocks)
'目','次','通','知','語','言','英','言','本','国','連',
'接','切','替','機','能','用','紙','出','力','入','力',
'電','源','気','点','検','索','結','果','手','動','自',
'動','送','信','受','信','発','送','返','事','宛','先',

# Common N5/N4 Essentials
